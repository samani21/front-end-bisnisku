import { HeaderContainer, HeaderLeft, Logo, HeaderRight, IconSvg, NoMeja, Container } from '@/components/Theme/Food1/Header'
import React from 'react'

const Header = (props) => {
    const { data, setViewPage } = props;
    return (
        <HeaderContainer>
            <Container>
                ...
                <HeaderRight color={data?.color_secondary}>
                    <IconSvg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" color={data?.color_primary}>
                    ...
                    <NoMeja color={data?.color_primary}>
                        08
                    </NoMeja>
                </HeaderRight>
            </Container>
